...
#TODO async await reply from file
# async def bot_print_number_of_rounds_full(season_year, rounds_in_season_year):
#     fake_rounds = [
#         rounds_in_season_year - 6,
#         rounds_in_season_year - 5,
#         rounds_in_season_year - 4,
...
#
#     await message.reply(
#         f'Max number of rounds in Regular Season {season_year} - {rounds_in_season_year - 7}\n'
#         f'Playoffs Best of Five: Round #{rounds_in_season_year - 2}\n'
#         f'Final Four Semifinal: Round #{rounds_in_season_year - 1}\n'
#         f'Final Four Final: Round #{rounds_in_season_year}\n'
